...
UAbilityTask_WaitCrouchClearance* UAbilityTask_WaitCrouchClearance::WaitCrouchClearance(UGameplayAbility* OwningAbility,float TargetHeightOffset, float SphereTraceRadius,
		bool bShowDebug)
{
